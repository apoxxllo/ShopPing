        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-2">
                    <div class="card-body">
                        <h3 class="card-title text-white">Total Money Received</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white">Php {{ number_format($totalAmount, 2) }}</h2>
                            <p class="text-white mb-0">All time</p>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-3">
                    <div class="card-body">
                        <h3 class="card-title text-white">Total Customers/Users</h3>
                        <div class="d-inline-block">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-4">
                    <div class="card-body">
                        ...
                        <div class="d-inline-block">
                            <h2 class="text-white">{{number_format($satisfaction,2)}}%</h2>
                            <p class="text-white mb-0">All time</p>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body pb-0 d-flex justify-content-between">
                                <div>
                                    ...
                                    <h3 class="m-0">Php {{ number_format($earningThisMonth, 2) }}</h3>
                                </div>
                                <div>
                                    {{-- <ul>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var shopData = @json($shopDataDashboard);

        // Prepare data for Chart.js
        var labels = shopData.map(data => data.shopName);
        var salesData = shopData.map(data => data.sales);

        var ctx = document.getElementById('shopSalesChart').getContext('2d');
