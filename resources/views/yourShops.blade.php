            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            @auth
                                @if (Auth::user()->favoriteShops->isNotEmpty())
                                    @php $isFav = false @endphp
                                    @foreach (Auth::user()->favoriteShops as $favoriteShop)
                                        @if ($favoriteShop->shop->id == $shop->id)
                                            <a class="btn btn-outline-dark btn-square active"
                                                href="/favoriteShop/{{ $shop->id }}"><i class="far fa-heart"></i></a>
                        ...
                        <a class="btn btn-outline-dark btn-square" href="/viewYourShop/{{ $shop->id }}"><i
                ...
                <div class="text-center py-4">
                    ...
                    <div class="text-primary mr-2">
                        @php
                            $averageRating = $shop->reviews->avg('rating'); // Calculate the average rating
                    ...
                    <small style="color: black;">({{ $shop->reviews_count }} reviews)</small>
                </div>
            </div>
        </div>
    @endforeach
